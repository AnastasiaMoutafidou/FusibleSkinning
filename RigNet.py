...
def start_rignet(paths_for_Blender, test_model_name, networkPrefix="RigNet"):
	...
	for f in range(0, test_model.num_of_frames):
		np.savetxt(os.path.dirname(__file__)+'\\lala\\'+networkPrefix +"RIGNET"+test_model_name+"_color"+str(f)+".obj", ApproximatedWithColor[:,:,f], fmt="%.6f", newline="\nv ",header="# model approximated!")
		with open(os.path.dirname(__file__)+'\\lala\\'+networkPrefix +"RIGNET"+test_model_name+"_color"+str(f)+".obj", "ab") as file:
			np.savetxt(file, dataFaces,fmt="%d", newline="\nf ")  



	np.savetxt(os.path.dirname(__file__)+'\\lala\\'+networkPrefix +"RIGNET-"+"change"+"rest_pose.txt", test_model_mesh_rest_pose, fmt="%.6f", newline="\nv ")
	for f in range(0, test_model.num_of_frames):
		np.savetxt(os.path.dirname(__file__)+'\\lala\\'+networkPrefix +"RIGNET-"+"change"+"_approx"+str(f)+".obj", Approximated[:,:,f], fmt="%.6f", newline="\nv ",header="# gallop model approximated!")
		with open(os.path.dirname(__file__)+'\\lala\\'+networkPrefix +"RIGNET-"+"change"+"_approx"+str(f)+".obj", "ab") as file:
			np.savetxt(file, dataFaces,fmt="%d", newline="\nf ")
	...
	for f in range(0, test_model.num_of_frames):
		np.savetxt(os.path.dirname(__file__)+'\\lala\\'+networkPrefix +"RIGNET"+test_model_name+"_approx"+str(f)+".obj", ApproximatedWithColor[:,:,f], fmt="%.6f", newline="\nv ",header="# gallop model approximated!")
		with open(os.path.dirname(__file__)+'\\lala\\'+networkPrefix +"RIGNET"+test_model_name+"_approx"+str(f)+".obj", "ab") as file:
			np.savetxt(file, dataFaces,fmt="%d", newline="\nf ")
